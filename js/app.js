(() => {
    ...
    function initSliders() {
        if (document.querySelector(".content-auctions__slider")) new core(".content-auctions__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".content-auctions__button--prev",
                nextEl: ".content-auctions__button--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
